                                ...
                                occupied = [
                                    {
                                        map.conditions = {
                                            "state == \"focused\"".string = {
                                                text = "{id}";
                                                foreground = "${settings.theme.colors.primary}FF";
                                                margin = 5;
                    ...
                    right = [
                        {
                            cpu = {
                                ...
                                content.map.conditions = {
                                    "id == ${toString config.custom.home-manager.hardware.cpuCount}" = [
                                        {
                                            string = {
                                                text = "{id}:";
                                                foreground = "${settings.theme.colors.primary}FF";
                        ...
                        }
                        {
                            network = {
                                poll-interval = 5000;
                                content.map.conditions = {
                                    "name == \"${config.custom.home-manager.hardware.networkInterface}\"" = [
                                        {
                                            string = {
                                                text = "󰖩 ";
                                                foreground = "${settings.theme.colors.primary}FF";
                        ...
                        {
                            battery = {
                                name = config.custom.home-manager.hardware.batteryName;
                                poll-interval = 3000;
                                content = [
                                    {
                                        string = {
