...
{
    options = {
        custom.home-manager.hardware.touchpadName = lib.mkOption { };
    };
    ...
    config = lib.mkIf config.custom.home-manager.desktop.enable {
        ...
        wayland.windowManager.river = {
            ...
            settings = {
                border-width = 3;
                background-color = "0x${settings.theme.colors.primary}";
                border-color-focused = "0x${settings.theme.colors.primary}";
                ...
                keyboard-layout = "hu";
                input = {
                    ${config.custom.home-manager.hardware.touchpadName} = {
                        natural-scroll = true;
                        tap = true;
                    };
                };
