...
in
{
    ...
    config = lib.mkIf config.custom.river.enable {
        ...
        wayland.windowManager.river = {
            ...
            settings = {
                border-width = 3;
                background-color = "0x${config.custom.theme.colors.primary}";
                border-color-focused = "0x${config.custom.theme.colors.primary}";
                border-color-unfocused = "0x${config.custom.theme.colors.secondary}";
