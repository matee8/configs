...
set_keymap("i", "<C-h>", "<Left>", { silent = true })
set_keymap("i", "<C-j>", "<Down>", { silent = true })
set_keymap("i", "<C-k>", "<Up>", { silent = true })
set_keymap("i", "<C-l>", "<Right>", { silent = true })

set_keymap("n", "H", "^", { silent = true })
set_keymap("n", "L", "$", { silent = true })

set_keymap("n", ";", ":", { silent = true })

set_keymap("n", "n", "nzz", { silent = true })
set_keymap("n", "N", "Nzz", { silent = true })
...
vim.api.nvim_create_autocmd("LspAttach", {
    callback = function()
        ...
        set_keymap("n", "<leader>ld", "<CMD>FzfLua lsp_definitions<CR>", {
            silent = true,
